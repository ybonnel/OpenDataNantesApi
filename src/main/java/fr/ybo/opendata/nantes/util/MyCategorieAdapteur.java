...
/**
 * Chargement du Categorie à partir de l'identifiant numérique dans
 * le fichier CSV.
 *
 * @author Damien Raude-Morvan
 */
public class MyCategorieAdapteur implements AdapterCsv<Categorie> {

    /**
     * {@inheritDoc}
     */
    @Override
    public Categorie parse(String chaine) {
        int value = Integer.valueOf(chaine);
        return Categorie.fromId(value);
    }
